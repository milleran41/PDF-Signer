...
- text typed into the editor;
- signatures created or saved by the user;
- local draft data used to restore work after a page refresh.
...
- the current draft document and overlay data for recovery after refresh;
- interface language preference.

The user can remove loaded document data by using the **Clear** button in the editor. Saved signatures can be managed from the signatures page.
